...
const allMenuGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/monitor-dashboard', label: '监控仪表盘', icon: 'ChartBarIcon' },
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/four-step-selection', label: '四步精选', icon: 'CheckCircleIcon' },
      { path: '/long-term-tracking-pool', label: '跟踪池', icon: 'EyeIcon' },
