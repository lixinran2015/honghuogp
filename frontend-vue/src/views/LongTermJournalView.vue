    ...
    <div v-if="showForm" class="mb-4 bg-white rounded-lg border border-border p-4">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
        <div>
          ...
          <input v-model="form.ts_code" type="text" class="w-full px-3 py-2 text-sm border border-border rounded-md" placeholder="000001.SZ" />
        </div>
        <div>
        ...
        <table class="w-full text-sm">
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-4 py-3 font-medium text-warmgray-900">{{ entry.ts_code }}</td>
