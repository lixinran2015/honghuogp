...
class FactFundamental(Base):
    ...
    roe: Mapped[Optional[decimal.Decimal]] = mapped_column(Numeric(8, 4), comment='ROE（%）')
    net_margin: Mapped[Optional[decimal.Decimal]] = mapped_column(Numeric(8, 4), comment='净利率（%）')
    gross_margin: Mapped[Optional[decimal.Decimal]] = mapped_column(Numeric(8, 4), comment='毛利率（%）')
    ...
    profit_volatility: Mapped[Optional[decimal.Decimal]] = mapped_column(Numeric(8, 4), comment='盈利波动率')
